...
$nomp=strtoupper($nompaciente);
$idest=0;
$conectID = odbc_connect("intranet2","intranet2","intranet2") or die ("NO HAY CONEXION");
$sql1="select max(idpaciente) from aepacientes"; 
$result1=odbc_exec($conectID,$sql1)or die(exit("Error en odbc_exec"));
$idpaciente=odbc_result($result1,1)+1;
$resp= "insert into aepacientes (idpaciente, nompaciente, docpaciente, fechaing) values ($idpaciente, '$nomp', $docpaciente, CURRENT_TIMESTAMP)";
...
?>
        ...
        <div class="alert alert-success" role="alert">
            <a href="#" class="alert-link">Usuario Almacenado con Exito</a>
        </div>
