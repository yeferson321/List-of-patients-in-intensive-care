...
<head>
    ...
    <meta http-equiv="Refresh" content="64;url=http://172.30.0.3:88/Aero/nuevo4.php">
...
<body>
    ...
    <div align="center" class="text-center row">
        ...
        <div class="">
            ...
            <table class="table .bg-light">
                <thead>
                    <tr>
                        <th class="border text" style="background-color: #6D6E71; color: #FFFFFF;" scope="col">
                            ADMISIONES</th>
                    </tr>
                </thead>
                <?php 
	...
	{if($cont==0)
	  {?>
                ...
                <tbody>
                    <tr>
                        <td class="border text2" style="color: #6D6E71;"><?php echo $nompaciente;?></td>
                    </tr>
                </tbody>
                <?php 
	  }
