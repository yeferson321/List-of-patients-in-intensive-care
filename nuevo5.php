...
<head>
    ...
    <meta http-equiv="Refresh" content="64;url=http://172.30.0.3:88/Aero/index.html">
    ...
    <div class="text-center row">
        ...
        <div class="col">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th class="border text" style="background-color: #00A8A5; color: #FFFFFF;" scope="col">
                            RECUPERACION</th>
                    </tr>
                </thead>
                <?php 
while(odbc_fetch_row($result9))
/*	*/
{
$mod = fmod("$cont", "2");    
if($mod==0)
$nompacienter=odbc_result($result9,1);
$nomestado=odbc_result($result9,2);
$fechaing=odbc_result($result9,3);	
if($cont<16)
{if($cont==0)
{?>
                <?php }?>
                <tbody>
                    <tr>
                        <td class="border text2" style="color: #00A8A5;"><?php echo $nompacienter;?></td>
                    </tr>
                </tbody>
                <?php 
}
