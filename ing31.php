...
<body>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <form id="incid" name="formulario" method="post" action="ing32.php">
            ...
            <form id="incid" name="formulario" method="post" action="ing22.php">
                ...
                <div align="center" class="Estilo3">EDITAR PACIENTE EN BLOQUE QUIRURGICO</div>
...
?>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control" aria-label="Default select example" type="text"
                                    name="nompaciente" id="nompaciente" value='<?php echo $nompaciente; ?>' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" class="form-control" type="text" name="docpaciente" id="docpaciente"
                                    value='<?php echo $docpaciente; ?>' />
                            </td>
                        </tr>
                ...
                <div align="center">
                    ...
                    <div class="guardar">
                        <button name="Guardar" type="submit" id="seguir" value="Guardar" class="btn btn-info"
