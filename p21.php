...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,42,0','id','Movie1','width','220','height','85','name','Movie1','pluginspage','http://www.macromedia.com/go/getflashplayer','src','Movie1','bgcolor','#FFFFFF','quality','high','swliveconnect','true','allowscriptaccess','samedomain','movie','Movie1' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,42,0" name="Movie1" width="220" height="85"
  id="Movie1">
