...
var tickerEntries = new Array(
  "El primer paso para la Calidad, es Creer en ella",
  "Clínica Los Rosales", 
  "Les desea una pronta recuperación"
  );
...
var tickerMargin = 30;                               // margin (pixels)
var tickerDelay = 8;                                // scrolling delay (smaller = faster)
var tickerSpacer = ".::";                            // spacer between ticker entries

var tickerBGColor = "#113684";                       // background color
var tickerHLColor = "#113684";                       // hilight (mouse over) color

var tickerFont = "Arial";  // font family (CSS-spec)
var tickerFontSize = 45;                             // font size (pixels)
var tickerFontColor = "WHITE";                        // font color
