...
$sql1="update aepacientes set nompaciente='$nompaciente', docpaciente=$docpaciente where idpaciente=$idpaciente"; 
...
?>
        ...
        <div class="alert alert-success" role="alert">
            <a href="#" class="alert-link">Cambio Realizado con Exito</a>
        </div>
